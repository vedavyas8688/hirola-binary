    ...
    <section className="py-10 md:py-20 lg:py-24 overflow-hidden bg-card-white">
      <div className="mx-auto w-full max-w-[1600px] px-4 md:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 md:gap-8 max-w-3xl mx-auto">
          <div className="bg-card-white rounded-lg shadow-lg p-6 md:p-8 text-center border border-luxury-gold">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 max-w-6xl mx-auto mt-8">
          <div className="bg-card-white rounded-lg shadow-lg p-6 text-center">
