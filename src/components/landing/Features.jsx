...
const FEATURES = [
  {
    ...
    body: "Discover a new dimension of urban living where modern aesthetics meet timeless luxury. Every residence is a masterpiece of design, featuring expansive glass facades and premium materials.",
    ...
    imageAlt: "Luxury modern apartment interior with floor-to-ceiling windows",
    imageRight: true,
  },
  {
    tag: "Lifestyle",
    title: "Curated Amenities",
    body: "Immerse yourself in a lifestyle of absolute convenience. From sunset terraces to lush tropical gardens, our curated spaces are designed to provide a serene escape within the city.",
    ...
    imageAlt: "Lush tropical garden terrace at sunset with architectural lighting",
    imageRight: false,
  },
];
  ...
  return (
    <>
      ...
      <section style={{
        ...
        {/* Rows — both visible in one screen */}
        <div style={{
          maxWidth: "1440px",
          margin: "0 auto",
          display: "flex",
