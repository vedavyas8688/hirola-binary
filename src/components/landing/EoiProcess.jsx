...
// ── Very dark green panel + gold glass, all from your theme tokens ──
        ...
        >
          ...
          <div className="relative">
            <div className="flex items-center gap-2.5">
              ...
              <span className="font-sans text-xs font-semibold uppercase tracking-[0.22em] text-cream-text/80">
                {lpProcessSection.eyebrow}
              </span>
            </div>
            <div className="mt-3 flex items-end gap-8">
              <h2 className="font-serif text-3xl font-semibold leading-[1.12] text-cream-text md:text-5xl">
          ...
          <div className="relative mt-10 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
            {lpProcess.map((s) => (
              ...
              >
                ...
                <h3 className="mt-2.5 font-serif text-2xl font-semibold leading-snug text-cream-text">{s.title}</h3>
                <span
          ...
          >
            ...
            <a
              href={lpProcessSection.bar.cta.href}
              className="group inline-flex items-center gap-2.5 rounded-full bg-white py-1.5 pl-2 pr-6 font-sans text-sm font-semibold text-luxury-green-dark transition-transform duration-300 hover:-translate-y-0.5"
            >
              <span
