...
const STYLES = `
  ...
  @media (max-width: 767px) {
    ...
    .lh-cta { width: 100%; padding: 14px 20px !important; }
  }
`;
        ...
        >
          ...
          <div className="lh-price-block lh-4" style={{ marginBottom: "14px" }}>
            ...
            <p style={{
              ...
              color: "var(--clr-gold-bright)", letterSpacing: "0.06em", margin: "0 0 4px",
            }}>
              ₹8,499 / sq.ft &nbsp;·&nbsp; EOI 100% Refundable
            </p>
            <p style={{
              fontFamily: "var(--font-sans)", fontSize: "9.5px", fontWeight: 500,
              color: "var(--clr-gold-bright)", letterSpacing: "0.1em",
              textTransform: "uppercase", opacity: 0.75, margin: 0,
            }}>
              ★ Special launch pricing for first 50 units only
            </p>
          </div>

          {/* Location */}
          <div className="lh-5" style={{
